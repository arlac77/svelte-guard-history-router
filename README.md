...
[![GitHub Issues](https://img.shields.io/github/issues/svelte-guard-history-router/svelte-guard-history-router.svg?style=flat-square)](https://github.com/svelte-guard-history-router/svelte-guard-history-router/issues)
[![Build Status](https://img.shields.io/endpoint.svg?url=https%3A%2F%2Factions-badge.atrox.dev%2Fsvelte-guard-history-router%2Fsvelte-guard-history-router%2Fbadge\&style=flat)](https://actions-badge.atrox.dev/svelte-guard-history-router/svelte-guard-history-router/goto)
[![Styled with prettier](https://img.shields.io/badge/styled_with-prettier-ff69b4.svg)](https://github.com/prettier/prettier)
[![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/)
[![Known Vulnerabilities](https://snyk.io/test/github/svelte-guard-history-router/svelte-guard-history-router/badge.svg)](https://snyk.io/test/github/svelte-guard-history-router/svelte-guard-history-router)
[![Coverage Status](https://coveralls.io/repos/svelte-guard-history-router/svelte-guard-history-router/badge.svg)](https://coveralls.io/github/svelte-guard-history-router/svelte-guard-history-router)
