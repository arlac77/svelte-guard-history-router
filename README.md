...
[![bundlejs](https://deno.bundlejs.com/?q=svelte-guard-history-router\&badge=detailed)](https://bundlejs.com/?q=svelte-guard-history-router)
...
Check out the code in the [example](/tests/app) folder,
...
then navigate to [localhost:5000](http://localhost:5173/)
...
- [Features](#features)
  - [Shared Leave Routes](#shared-leave-routes)
- [usage](#usage)
